...
* File Name: IslandsOf1s.java
* Create Date: Jun 30, 2016
* Create Time: 8:29:09 PM
...
public class IslandsOf1s {
 ...
 // A utility function to do DFS for a 2D boolean matrix.
    ...
    public static void main1 (String[] args) throws java.lang.Exception    {
        ...
        IslandsOf1s I = new IslandsOf1s();
        System.out.println("Number of islands is: "+ I.countIslands(M));
    }
    
    public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in);
		int r = scanner.nextInt(), m = scanner.nextInt(), n = scanner.nextInt();
